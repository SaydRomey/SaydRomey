...
At [42 Québec](https://www.42quebec.com), I grew strong in problem-solving, 
project-based learning, and technical teamwork.  

I love automating workflows, writing utility scripts, documenting, 
and building reusable components — 
whether for scripting or game dev experiments.
...
This project is meant to be a data tracking and organizer i can use 
to keep track of baby-related events and information.  -->

### [PythonPlayground](https://github.com/SaydRomey/PythonPlayground)  
An experimental space for some apps, tools, scripts and tests 
as I finally join the cool kids and learn Python.

### [ColorGame](https://github.com/SaydRomey/ColorGame)  
I'm building a color-themed universe for a future video game — 
from lore and mythology to NPC archetypes and core mechanics.  
...
### Exams
- **[Exam Repository](https://github.com/SaydRomey/exams)**: 
    Personal solutions for 42 exams with an exam simulator.
...
<details>
  <summary>
    <strong>Inspect Character Sheet</strong>
  </summary>
...
<details>
  <summary>
    <strong>Open Guild Records</strong>
  </summary>
  ...
  <table>
    <tr>
      <td style="padding-right: 0.75rem; vertical-align: top;"><strong>Rank</strong>:</td>
      <td>42 Cursus Junior Developer — Level 9</td>
    </tr>
    <tr>
      <td style="padding-right: 0.75rem; vertical-align: top;"><strong>Affiliation</strong>:</td>
      <td><a href="https://www.42quebec.com">42 Québec</a></td>
    </tr>
    <tr>
      <td style="padding-right: 0.75rem; vertical-align: top;"><strong>Completed Trials</strong>:</td>
      <td>
        Common Core projects in C, systems, networking, graphics, containers, shell design, and C++.
      </td>
    </tr>
    <tr>
      <td style="padding-right: 0.75rem; vertical-align: top;"><strong>Current Focus</strong>:</td>
      <td>
        Documentation, automation, Python exploration, and game-dev worldbuilding.
      </td>
    </tr>
  </table>
  ...
  <p><strong>Campus Record</strong></p>

  <a href="https://profile.intra.42.fr/users/cdumais">
    <img src="https://badge.mediaplus.ma/greenbinary/cdumais?1337Badge=off&UM6P=off" alt="42 stats badge"/>
  </a>

  <p>
    Additional records, certifications, and campaign milestones may be inscribed here over time.
  </p>
</details>
